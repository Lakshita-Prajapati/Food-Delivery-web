...
<html lang="en">
  ...
  <body>
    ...
    <header class="header">
      ...
      <!--=============== SignIn Form ===============-->
      <div class="wrapper" id="signinForm" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5); z-index: 9999; justify-content: center; align-items: center; opacity: 0; visibility: hidden; transition: opacity 0.3s ease;">
        <form action="auth.php" method="POST" class="form" style="background: white; padding: 2rem; border-radius: 8px; width: 100%; max-width: 400px; position: relative;">
          <h2>SIGN IN</h2>
          ...
          <div class="control">
            ...
            <input type="email" id="email" name="email" placeholder="Enter Your Email" required style="width: 100%; padding: 0.5rem; margin-bottom: 1rem;" />
          </div>
          <div class="control">
            <label for="password">Password:</label>
            <input type="password" id="password" name="password" placeholder="Password" required style="width: 100%; padding: 0.5rem; margin-bottom: 1rem;" />
          </div>
          <div class="checkbox d-flex">
            <input type="checkbox" id="remember" name="remember" />
            <span>Remember Me</span>
          </div>
          <button type="submit" name="login" class="btn" style="width: 100%; margin: 1rem 0;">Sign In</button>
          <div class="links">
        ...
        <div class="close-form" id="closeForm" style="position: absolute; top: 1rem; right: 1rem; cursor: pointer;">
          <i class="bx bx-x"></i>
        </div>
      </div>
    </header>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function() {
        ...
        if (!signinBtn || !signinForm || !closeForm) {
        ...
        signinBtn.addEventListener('click', function(e) {
          ...
          e.preventDefault();
          console.log('Current form display:', signinForm.style.display);
          signinForm.style.display = 'flex';
          signinForm.style.opacity = '1';
          signinForm.style.visibility = 'visible';
          console.log('New form display:', signinForm.style.display);
        });
